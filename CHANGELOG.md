...
## [0.0.1](https://github.com/devanshusanghani/privateGPT/compare/v0.5.0...v0.0.1) (2024-04-17)
...
* **code:** improve concat of strings in ui ([#1785](https://github.com/devanshusanghani/privateGPT/issues/1785)) ([bac818a](https://github.com/devanshusanghani/privateGPT/commit/bac818add51b104cda925b8f1f7b51448e935ca1))
...
* **docker:** set default Docker to use Ollama ([#1812](https://github.com/devanshusanghani/privateGPT/issues/1812)) ([f83abff](https://github.com/devanshusanghani/privateGPT/commit/f83abff8bc955a6952c92cc7bcb8985fcec93afa))
* **docs:** Add guide Llama-CPP Linux AMD GPU support ([#1782](https://github.com/devanshusanghani/privateGPT/issues/1782)) ([8a836e4](https://github.com/devanshusanghani/privateGPT/commit/8a836e4651543f099c59e2bf497ab8c55a7cd2e5))
...
* **llm:** Ollama LLM-Embeddings decouple + longer keep_alive settings ([#1800](https://github.com/devanshusanghani/privateGPT/issues/1800)) ([b3b0140](https://github.com/devanshusanghani/privateGPT/commit/b3b0140e244e7a313bfaf4ef10eb0f7e4192710e))
* **llm:** Ollama timeout setting ([#1773](https://github.com/devanshusanghani/privateGPT/issues/1773)) ([6f6c785](https://github.com/devanshusanghani/privateGPT/commit/6f6c785dac2bbad37d0b67fda215784298514d39))
...
* **rag:** expose similarity_top_k and similarity_score to settings ([#1771](https://github.com/devanshusanghani/privateGPT/issues/1771)) ([087cb0b](https://github.com/devanshusanghani/privateGPT/commit/087cb0b7b74c3eb80f4f60b47b3a021c81272ae1))
* **RAG:** Introduce SentenceTransformer Reranker ([#1810](https://github.com/devanshusanghani/privateGPT/issues/1810)) ([83adc12](https://github.com/devanshusanghani/privateGPT/commit/83adc12a8ef0fa0c13a0dec084fa596445fc9075))
...
* **scripts:** Wipe qdrant and obtain db Stats command ([#1783](https://github.com/devanshusanghani/privateGPT/issues/1783)) ([ea153fb](https://github.com/devanshusanghani/privateGPT/commit/ea153fb92f1f61f64c0d04fff0048d4d00b6f8d0))
...
* **ui:** Add Model Information to ChatInterface label ([f0b174c](https://github.com/devanshusanghani/privateGPT/commit/f0b174c097c2d5e52deae8ef88de30a0d9013a38))
...
* **UI:** Faster startup and document listing ([#1763](https://github.com/devanshusanghani/privateGPT/issues/1763)) ([348df78](https://github.com/devanshusanghani/privateGPT/commit/348df781b51606b2f9810bcd46f850e54192fd16))
...
* wipe per storage type ([#1772](https://github.com/devanshusanghani/privateGPT/issues/1772)) ([c2d6948](https://github.com/devanshusanghani/privateGPT/commit/c2d694852b4696834962a42fde047b728722ad74))
...
* Fixed docker-compose ([#1758](https://github.com/devanshusanghani/privateGPT/issues/1758)) ([774e256](https://github.com/devanshusanghani/privateGPT/commit/774e2560520dc31146561d09a2eb464c68593871))
* **ingest:** update script label ([#1770](https://github.com/devanshusanghani/privateGPT/issues/1770)) ([7d2de5c](https://github.com/devanshusanghani/privateGPT/commit/7d2de5c96fd42e339b26269b3155791311ef1d08))
* **llm:** special tokens and leading space ([#1831](https://github.com/devanshusanghani/privateGPT/issues/1831)) ([347be64](https://github.com/devanshusanghani/privateGPT/commit/347be643f7929c56382a77c3f45f0867605e0e0a))
